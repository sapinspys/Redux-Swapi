...
- **Start** in `src/index.js`. We'll need to pull in the appropriate packages. Done!
- **Next** after you're all wired up in your `index` lets move over to work on your reducers. Done!
